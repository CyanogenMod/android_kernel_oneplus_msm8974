...
struct synaptics_rmi4_data {
	...
	atomic_t circle_gesture_enable;
	atomic_t down_swipe_gesture_enable;
	atomic_t left_arrow_gesture_enable;
	atomic_t right_arrow_gesture_enable;
	atomic_t v_gesture_enable;
